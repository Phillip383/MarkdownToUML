...
class Generator():
    ...
    def generate_image(self, type, splitter: Splitter):
        ...
        for diagram in splitter.get_diagrams():
            draw.text([240, 0], diagram.get_name(), fill=(0,0,0), font_size=12, align="center")
    ...
    def generate_class_info(self, draw, diagram, vert_draw_pos):
        for attribute in diagram.get_attributes():
            draw.text([15, vert_draw_pos], attribute, fill=(0,0,0), font_size=12, align="center")
            vert_draw_pos += 15
        ...
        for method in diagram.get_methods():
            draw.text([15, vert_draw_pos], method, fill=(0,0,0), font_size=12, align="center")
            vert_draw_pos += 15